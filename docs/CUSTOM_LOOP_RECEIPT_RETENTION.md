...
A governed cleanup request binds the artifact class, operation ID, actor, surface, request time, exact replay cutoff, and caller-selected count/byte bounds. Its canonical SHA-256 hash prevents a reused cleanup ID from changing scope.
