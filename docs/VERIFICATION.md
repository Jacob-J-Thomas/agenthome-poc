...
Every canonical qualification test project has one checked-in measured scheduling profile. The two Windows-dominant suites therefore start first and retain bounded child headroom beneath the eight-minute global deadline, while a new project without a profile fails closed.
