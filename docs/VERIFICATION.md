...
Every canonical qualification test project and verifier contract has one checked-in measured scheduling profile. The two Windows-dominant suites therefore start first and retain bounded child headroom beneath the eight-minute global deadline, while a new project without a profile fails closed. The four-unit capacity admits at most two two-unit dominant suites; as capacity opens, one-unit short suites and verifier contracts may backfill up to the unchanged four-process ceiling.
