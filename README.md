...
Run discovery uses stable opaque cursors, supports an exact loop-id filter, and progressively loads older live traces and tombstones without dropping the current selection. Deleted definitions remain available as archived history as older pages are discovered.
