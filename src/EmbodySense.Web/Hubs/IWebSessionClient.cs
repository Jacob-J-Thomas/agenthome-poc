...
public interface IWebSessionClient
{
    ...
    /// <returns>A task that completes when the client receives the notification.</returns>
    ...
    /// <returns>A task that completes when the client receives the event.</returns>
