...
/// <summary>
/// Adapts authenticated Web requests to custom-loop invocation and explicit resume operations.
/// </summary>
public interface IWebLoopRuntimeInvoker
{
    ...
    /// <param name="ownerConnectionId">The authenticated SignalR connection correlated with the request; it is not approval authority.</param>
