...
/// <param name="InitializationRequiresCleanup">Whether an unusable protected seed document or nonreplaceable completion-marker path must be cleaned up before initialization can succeed.</param>
