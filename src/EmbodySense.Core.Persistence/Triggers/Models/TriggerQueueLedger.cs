...
internal sealed record TriggerQueueLedger(long Generation, string? PreviousGenerationHash, TriggerQueueQuota Quota, IReadOnlyList<TriggerQueueLedgerEntry> Entries);
