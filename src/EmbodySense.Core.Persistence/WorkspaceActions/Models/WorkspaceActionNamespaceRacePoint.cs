...
public enum WorkspaceActionNamespaceRacePoint
{
    ...
    /// <summary>The final exact Windows before-image check completed immediately before atomic replacement.</summary>
    AfterWindowsReplacementFinalCheckBeforeReplaceSystemCall = 5,

    /// <summary>Atomic replacement returned before the private backup was opened and authenticated.</summary>
