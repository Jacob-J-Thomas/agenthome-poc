...
public sealed record HumanReviewDecisionActionRetirement(int SchemaVersion, string RetirementId, HumanReviewDecisionActionWakeReference Wake, HumanReviewDecisionActionReservationReference Reservation, long ExpectedGeneration, HumanReviewContinuationOutcome Outcome, DateTimeOffset RetiredAtUtc, ImmutableArray<HumanReviewRedactedPreview> Evidence, HumanReviewProvenance Provenance, string RetirementHash)
{
