...
public sealed record HumanReviewContinuationCompletion(int SchemaVersion, string CompletionId, HumanReviewContinuationWakeReference Wake, HumanReviewContinuationClaimReference Claim, HumanReviewContinuationReservationReference Reservation, long ExpectedGeneration, DateTimeOffset CompletedAtUtc, ImmutableArray<HumanReviewRedactedPreview> Evidence, HumanReviewProvenance Provenance, string CompletionHash)
{
