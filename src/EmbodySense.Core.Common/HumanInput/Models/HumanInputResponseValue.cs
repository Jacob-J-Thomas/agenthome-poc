...
public sealed partial record HumanInputResponseValue(HumanInputResponseKind Kind, string? Text, string? ChoiceId, bool? Confirmation, ImmutableArray<HumanInputStructuredFieldValue>? StructuredFields, HumanInputReference? Reference);
