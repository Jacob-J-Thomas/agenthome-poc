    ...
    public static CustomLoopContextSnapshot CreateEmpty(DateTimeOffset capturedAtUtc)
    {
        var snapshot = new CustomLoopContextSnapshot(
            ...
            [
                ...
                OmittedWorkspaceSource(3, CustomLoopContextSource.RoleInstruction, "soul", CustomLoopContextProvenance.AgentIdentityFile, CustomLoopContextTrustClass.TrustedInstruction, LlmMessageRole.System, capturedAtUtc),
                OmittedWorkspaceSource(4, CustomLoopContextSource.RoleInstruction, "personality", CustomLoopContextProvenance.AgentIdentityFile, CustomLoopContextTrustClass.TrustedInstruction, LlmMessageRole.System, capturedAtUtc),
