...
/// <summary>Selects one bounded deterministic page of registered reconciliation probes.</summary>
...
public sealed record GovernedLoopEffectReconciliationProbeRegistryListRequest(int MaximumCount, string? Cursor = null)
{
