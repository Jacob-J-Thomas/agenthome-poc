...
/// <param name="PreparedWakeEvidence">The exact detached prepared-wake evidence admitted before continuation, or <see langword="null"/> only for read-only reconciliation.</param>
