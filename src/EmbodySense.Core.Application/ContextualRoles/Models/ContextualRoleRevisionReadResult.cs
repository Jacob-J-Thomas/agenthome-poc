...
/// <param name="Disposition">The proved current or historical lifecycle disposition of the exact revision.</param>
/// <param name="ValidationErrors">Structured request errors when <paramref name="Status"/> is invalid.</param>
public sealed record ContextualRoleRevisionReadResult(ContextualRoleRevisionReadStatus Status, ContextualRoleRevision? Revision, ContextualRoleRevisionDisposition Disposition, IReadOnlyList<ContextualRoleValidationError> ValidationErrors);
