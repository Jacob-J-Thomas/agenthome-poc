...
public static class RuntimeCommandRegistry
{
    ...
    [
        ...
        new RuntimeCommandDefinition(RuntimeCommandId.DefaultConversationReview, ["/review"], "inspect or explicitly resolve an outcome-unknown default-conversation turn", ["/review", "/review resolve <turn-id>"]),
