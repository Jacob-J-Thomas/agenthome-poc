...
internal sealed class TimeProviderHumanReviewTrustedClock : IHumanReviewTrustedClock
{
    ...
    internal TimeProviderHumanReviewTrustedClock(TimeProvider timeProvider)
