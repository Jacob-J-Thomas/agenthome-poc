...
/// <param name="Loop">The exact closed legacy-definition or governed-publication target reference.</param>
...
public sealed record TriggerWorkerCurrentEvidenceInput(string DeliveryId, TriggerLoopReference Loop, string AdapterCapabilityId, string AdapterCapabilityVersion, string AdapterDescriptorHash, string AdapterProviderId, string AdapterImplementationId, string ActorId, string SurfaceId, string WorkspaceId, string RoleId, string AuthorityProfileId, string AuthorityProfileRevision);
