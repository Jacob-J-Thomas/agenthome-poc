...
/// <remarks>
/// Implementations compose the canonical schedule evaluator, trigger worker, sleep service, and Human Input continuation
/// bridge. They must not report completion before the underlying one-shot operation returns its durable outcome.
/// </remarks>
