...
/// </summary>
/// <param name="SchemaVersion">The persisted definition schema version.</param>
/// <param name="Id">The stable loop identity.</param>
/// <param name="DefinitionVersion">The monotonically increasing optimistic-concurrency version.</param>
/// <param name="ContentHash">The canonical definition content hash.</param>
/// <param name="CreatedAtUtc">The durable creation timestamp.</param>
/// <param name="UpdatedAtUtc">The durable last-update timestamp.</param>
...
/// <param name="LastMutationOperationId">The idempotency identity of the last committed definition mutation.</param>
