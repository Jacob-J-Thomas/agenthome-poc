...
/// <param name="IsInitialized">Whether the agent directory contains a readable, nonblank role document, a valid current-version permissions document, a valid completion marker, and bounded proof of the exact published and active default contextual role.</param>
/// <param name="HasPartialScaffold">Whether an incomplete <c>.agent</c> scaffold exists and requires repair.</param>
/// <param name="RequiresExplicitCleanup">Whether an existing partial or invalid <c>.agent</c> must be explicitly removed before fresh initialization can succeed.</param>
