...
{
    /// <summary>Gets the shipped Codex model-profile capability identity.</summary>
    public const string CodexModelProfileCapabilityId = "org.embodysense/model-profile/codex";
    ...
    public static IReadOnlyList<CapabilityDescriptor> Descriptors { get; } = Array.AsReadOnly(new[]
    {
        ...
        Create(CodexModelProfileCapabilityId, "model-profile/codex", CapabilityKind.ModelProfile, CapabilitySideEffectClass.None, "Route one exact configured Codex model through the governed runtime.", CapabilityEgressMode.Unrestricted),
    ...
    private static CapabilityDescriptor Create(string idValue, string implementationId, CapabilityKind kind, CapabilitySideEffectClass sideEffectClass, string purpose, CapabilityEgressMode egressMode = CapabilityEgressMode.None)
    {
        ...
        return new CapabilityDescriptor(
            ...
            sideEffectClass,
            new CapabilityAccessRequirements([], egressMode, [], []));
    }
}
