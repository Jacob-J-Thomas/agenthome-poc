...
function Get-VerificationTestProjectLanes {
    ...
    if ($TestProject.Name -eq "EmbodySense.Core.Startup.Tests.csproj") {
        return @(
            ...
            (New-VerificationTestLane -Name "remainder" -ExcludeFullyQualifiedName @("EmbodySense.Core.Startup.Tests.Loops.Execution.CustomLoopRuntimeTests", "EmbodySense.Core.Startup.Tests.Loops.Execution.GovernedLoopRuntimeTests"))
        )
    }
    ...
    if ($TestProject.Name -eq "EmbodySense.IntegrationTests.csproj") {
        return @(
            ...
            (New-VerificationTestLane -Name "remainder" -ExcludeFullyQualifiedName @("EmbodySense.IntegrationTests.CodexAppServer"))
        )
    }
    ...
    if ($TestProject.Name -eq "EmbodySense.Web.Tests.csproj") {
        return @(
            ...
            (New-VerificationTestLane -Name "remainder" -ExcludeFullyQualifiedName @("EmbodySense.Web.Tests.WebAgentRuntimeHostTests"))
        )
    }
