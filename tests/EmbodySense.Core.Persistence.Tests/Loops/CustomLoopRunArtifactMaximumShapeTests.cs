...
public sealed class CustomLoopRunArtifactMaximumShapeTests
{
    ...
    private static CustomLoopContextSnapshot MaximumContext()
    {
        var workspace = new[]
        {
            ...
            ("soul", "root/.agent/SOUL.md", CustomLoopContextSource.AgentIdentity, CustomLoopContextProvenance.WorkspaceAgentIdentityFile, CustomLoopContextTrustClass.TrustedInstruction, LlmMessageRole.System),
            ("personality", "root/.agent/PERSONALITY.md", CustomLoopContextSource.AgentIdentity, CustomLoopContextProvenance.WorkspaceAgentIdentityFile, CustomLoopContextTrustClass.TrustedInstruction, LlmMessageRole.System),
