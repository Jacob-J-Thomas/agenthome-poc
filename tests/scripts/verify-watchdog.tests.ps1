...
Assert-Equal -Actual $broadApplicationVerifierSharedWaveSeconds -Expected 420 -Message "The complete broad Application-plus-verifier shared wave must retain its calibrated scheduler critical path."
