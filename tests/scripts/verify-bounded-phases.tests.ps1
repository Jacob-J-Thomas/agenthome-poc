...
Assert-Contains -Actual $laneScript -Expected 'New-VerificationTestLane -Name "authority-grants-process" -IncludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Authority.AuthorityGrantStoreTests")' -Message "Nested-VSTest authority-grant persistence tests must have an independently governed lane."
Assert-Contains -Actual $laneScript -Expected 'New-VerificationTestLane -Name "authority-remainder" -IncludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Authority") -ExcludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Authority.AuthorityGrantStoreTests")' -Message "The authority remainder must explicitly exclude nested-VSTest grant tests."
Assert-Contains -Actual $laneScript -Expected 'New-VerificationTestLane -Name "credentials-external-process" -IncludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Credentials.WindowsCredentialValueProviderTests")' -Message "The remaining external credential-provider fixture must have an independently governed lane."
Assert-Contains -Actual $laneScript -Expected 'New-VerificationTestLane -Name "credentials-remainder" -IncludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Credentials") -ExcludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Credentials.WindowsCredentialValueProviderTests")' -Message "The credentials remainder must explicitly exclude the external provider fixture."
Assert-Contains -Actual $laneScript -Expected 'New-VerificationTestLane -Name "tool-results" -IncludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.ToolResults")' -Message "Tool-result persistence tests must retain an ordinary bounded lane."
Assert-Contains -Actual $laneScript -Expected 'New-VerificationTestLane -Name "audit-process" -IncludeFullyQualifiedName @("EmbodySense.Core.Persistence.Tests.Audit")' -Message "Audit helper-process tests must have an independently governed lane."
...
foreach ($heavyLane in @("EmbodySense.Core.Persistence.Tests-authority-grants-process", "EmbodySense.Core.Persistence.Tests-credentials-external-process", "EmbodySense.Core.Persistence.Tests-default-conversation-recovery", "EmbodySense.Core.Persistence.Tests-governed-lifecycle", "EmbodySense.Core.Persistence.Tests-human-input-requests", "EmbodySense.Core.Persistence.Tests-human-input-responses", "EmbodySense.Core.Persistence.Tests-triggers", "EmbodySense.Core.Startup.Tests-loop-execution-custom-runtime", "EmbodySense.Core.Startup.Tests-loop-execution-governed-runtime")) {
