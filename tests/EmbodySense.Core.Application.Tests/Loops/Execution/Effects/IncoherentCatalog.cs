...
internal sealed class IncoherentCatalog : IGovernedActuatorCatalogResolver
{
    ...
    public Task<GovernedActuatorCatalogResolutionResult> ResolveAsync(CapabilityAdmissionPin pin, string operationId, CancellationToken cancellationToken = default)
        => Task.FromResult(new GovernedActuatorCatalogResolutionResult(GovernedActuatorCatalogResolutionStatus.Active, null, null, null, "incoherent"));
}
